...
float CPUTimer::MilliSeconds() {
  ...
  this->elapsed_milliseconds_ = (this->stop_cpu_ - this->start_cpu_).total_milliseconds();
...
float CPUTimer::MicroSeconds() {
  ...
  this->elapsed_microseconds_ = (this->stop_cpu_ - this->start_cpu_).total_microseconds();
