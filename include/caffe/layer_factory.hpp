 ...
 * During runtime, registered layers can be called by passing a LayerParameter protobuffer to the CreateLayer function:
 ...
 *      // your implementation
 *    }
 * (for example, when your layer has multiple backends, see GetConvolutionLayer for a use case), 
