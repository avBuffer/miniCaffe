...
// Return true iff any layer contains parameters specified using deprecated V0LayerParameter.
...
// For any padding layer, remove it and put its pad parameter in any layers taking its top blob as input.
...
// Perform all necessary transformations to upgrade old transformation fields into a TransformationParameter.
...
// Perform all necessary transformations to upgrade a NetParameter with deprecated V1LayerParameters.
