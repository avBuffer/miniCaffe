...
/* @brief A wrapper around SyncedMemory holders serving as the basic computational unit
 *        through which Layer%s, Net%s, and Solver%s interact.
...
class Blob {
 public:
   ...
   * When changing the size of blob, memory will only be reallocated 
   * if sufficient memory does not already exist, and excess memory will never be freed.
   *
