...
/**
 * @brief Exponential Linear Unit non-linearity @f$ y = \left\{
 *        \begin{array}{lr}
 *            x                  & \mathrm{if} \; x > 0 \\
...
class ELULayer : public NeuronLayer<Dtype> {
 public:
  /* @param param provides ELUParameter elu_param, with ELULayer options: - alpha (\b optional, default 1).
 ...
 protected:
   ...
   *   -# @f$ (N \times C \times H \times W) @f$ the inputs @f$ x @f$; Backward fills their diff with gradients @f$
