 ...
 *        as specified by the scale @f$ \alpha @f$, shift @f$ \beta @f$, and base @f$ \gamma @f$. */
template <typename Dtype>
class LogLayer : public NeuronLayer<Dtype> {
 public:
  /* @param param provides LogParameter log_param, with LogLayer options:
 ...
 protected:
   ...
   *   -# @f$ (N \times C \times H \times W) @f$ the computed outputs @f$ y = log_{\gamma}(\alpha x + \beta) @f$ */
   ...
   *      gradients @f$ \frac{\partial E}{\partial x} = \frac{\partial E}{\partial y} y \alpha \log_e(gamma)
