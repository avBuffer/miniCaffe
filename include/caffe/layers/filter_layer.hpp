...
/* @brief Takes two+ Blobs, interprets last Blob as a selector and filter remaining Blobs accordingly with selector data (0 means that
 * the corresponding item has to be filtered, non-zero means that corresponding item needs to stay). */
...
class FilterLayer : public Layer<Dtype> {
 ...
 protected:
   ...
   *   -# @f$ (N \times C \times H \times W) @f$ the inputs to be filtered @f$ x_1 @f$
   *   -# ...
   *   -# @f$ (N \times C \times H \times W) @f$ the inputs to be filtered @f$ x_K @f$
   *   -# @f$ (N \times 1 \times 1 \times 1) @f$ the selector blob
   ...
   * @param bottom input Blob vector (length 2+), into which the top error gradient is copied */
