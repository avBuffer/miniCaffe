...
/* @brief TanH hyperbolic tangent non-linearity @f$ y = \frac{\exp(2x) - 1}{\exp(2x) + 1} @f$, popular in auto-encoders.
...
class TanHLayer : public NeuronLayer<Dtype> {
 ...
 protected:
   ...
   *   -# @f$ (N \times C \times H \times W) @f$ the computed outputs @f$ y = \frac{\exp(2x) - 1}{\exp(2x) + 1} @f$ */
   ...
   *      gradients @f$ \frac{\partial E}{\partial x}
   *            = \frac{\partial E}{\partial y} \left(1 - \left[\frac{\exp(2x) - 1}{exp(2x) + 1} \right]^2 \right)
   *            = \frac{\partial E}{\partial y} (1 - y^2) @f$ if propagate_down[0] */
