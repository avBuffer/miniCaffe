...
/* @brief Provides data to the Net from memory. TODO(dox): thorough documentation for Forward and proto params. */
...
class MemoryDataLayer : public BaseDataLayer<Dtype> {
 public:
  ...
  // Reset should accept const pointers, but can't, because the memory will be given to Blob, which is mutable
