...
class AbsValLayer : public NeuronLayer<Dtype> {
 public:
  explicit AbsValLayer(const LayerParameter& param) : NeuronLayer<Dtype>(param) {}
 ...
 protected:
   ...
   *      gradients @f$ \frac{\partial E}{\partial x} = \mathrm{sign}(x) \frac{\partial E}{\partial y}
   *      @f$ if propagate_down[0]n*/
