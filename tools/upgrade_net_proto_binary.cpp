...
// Usage: upgrade_net_proto_binary v0_net_proto_file_in net_proto_file_out
#include <cstring>
...
int main(int argc, char** argv) {
  ...
  if (argc != 3) {
    LOG(ERROR) << "Usage: upgrade_net_proto_binary v0_net_proto_file_in net_proto_file_out";
    return 1;
  }
