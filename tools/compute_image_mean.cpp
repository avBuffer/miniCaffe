...
DEFINE_string(backend, "lmdb", "The backend {lmdb} containing the images");
...
int main(int argc, char** argv) {
  ...
  gflags::SetUsageMessage("Compute the mean_image of a set of images given by a lmdb\n"
                          "Usage: compute_image_mean [FLAGS] INPUT_DB [OUTPUT_FILE]\n");
